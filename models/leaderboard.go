...
type LeaderboardSuccessResponse struct {
	...
	Data            []*Game `json:"data"`            // The data to be displayed in the table //TODO: check if interface works
}

// NewLeaderboardSuccessResponse creates a new success response to be consumed by the databale api
func NewLeaderboardSuccessResponse(draw int64, games []*Game, totalCount, totalFiltered int64) LeaderboardSuccessResponse {
